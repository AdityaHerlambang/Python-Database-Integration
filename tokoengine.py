...
while (1):
    ...
    try:
        ...
        result = functions.select(config.tables_1[0],cursor_toko)
        history = functions.select(config.histories_1[0],cursor_toko)
        ...
        if(len(result) > len(history)):
            ...
            for data in result:
                ...
                if (a == 0):
                    ...
                    functions.insert(config.tables_1[0],data,cursor_bank,db_bank)
        ...
        if(len(result) < len(history)):
            ...
            for dataHistory in history:
                ...
                if (a == 0):
                    ...
                    functions.delete(config.tables_1[0],dataHistory,cursor_bank,db_bank)
                ...
                for dataHistory in history:
                    if (data[0] == dataHistory[0]):
                        if(data != dataHistory):
                            ...
                            functions.update(config.tables_1[0],data,cursor_bank,db_bank)
